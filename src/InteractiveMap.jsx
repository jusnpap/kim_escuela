...
const zones = [
  ...
  { id: 'entrada', title: "Ingreso Principal y Seguridad", desc: "Puerta principal con rampa de acceso antideslizante, barandillas dobles y caseta de vigilancia. (Render 3D en pausa por límite del servidor).", style: { left: '20%', top: '20%', width: '8%', height: '12%' }, zoom: 2.5, has3D: false },
