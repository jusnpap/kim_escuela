...
const zones = [
  ...
  { id: 'entrada', title: "Ingreso Principal y Seguridad", desc: "Puerta principal con rampa de acceso antideslizante, barandillas dobles y caseta de vigilancia. (Render 3D en pausa por límite del servidor).", style: { left: '2%', top: '40%', width: '12%', height: '18%' }, zoom: 2.5, has3D: false },
